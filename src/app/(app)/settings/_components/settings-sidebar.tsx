 ...
 *
 * IT TAKES THE NAV AS A PROP AND FILTERS NOTHING. The previous version read
 * SETTINGS_NAV directly and its comment claimed this sidebar and the account
 * dropdown "can never drift apart" — while they had. The list was shared; the
 * `adminOnly` FILTER was not, so each renderer had to remember to apply it and
 * this one did not. A contributor saw all nine entries, including a live link
 * to org-wide configuration.
 *
 * The server layout now resolves visibility once via visibleSettingsNav() and
 * hands down what this user should see. This component cannot drift because it
